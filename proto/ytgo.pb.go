...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_bce4a56029ad242f, []int{0}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_bce4a56029ad242f, []int{1}
}
...
func init() {
	proto.RegisterType((*Request)(nil), "ytgo.Request")
	proto.RegisterType((*Response)(nil), "ytgo.Response")
}

func init() { proto.RegisterFile("ytgo.proto", fileDescriptor_bce4a56029ad242f) }

var fileDescriptor_bce4a56029ad242f = []byte{
	// 132 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0xaa, 0x2c, 0x49, 0xcf,
	...
	0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x25, 0x05, 0x2e, 0x8e, 0xa0, 0xd4, 0xe2,
	0x82, 0xfc, 0xbc, 0xe2, 0x54, 0x21, 0x11, 0x2e, 0xd6, 0xcc, 0x5c, 0x88, 0x1a, 0x66, 0x0d, 0x9e,
	0x20, 0x08, 0xc7, 0xc8, 0x00, 0x64, 0x4c, 0x59, 0x6a, 0x51, 0x71, 0xaa, 0x90, 0x2a, 0x17, 0x93,
	0x4b, 0xbe, 0x10, 0xaf, 0x1e, 0xd8, 0x2a, 0xa8, 0xd9, 0x52, 0x7c, 0x30, 0x2e, 0xc4, 0x14, 0x25,
	0x86, 0x24, 0x36, 0xb0, 0x2b, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x9c, 0xf1, 0x4e, 0x58,
	0x93, 0x00, 0x00, 0x00,
}
...
func (c *reverseClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ytgo.Reverse/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
